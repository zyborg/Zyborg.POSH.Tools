...
namespace Zyborg.POSH.BinDoc.Model
{
	...
	/// <see cref="https://github.com/red-gate/XmlDoc2CmdletDoc/blob/master/XmlDoc2CmdletDoc.Core/Domain/Parameter.cs"
	/// >XmlDoc2CmdletDoc.Core/Domain/Parameter.cs</see>
	/// </remarks>
	public class AsmParameter
	{
		...
		public AsmParameter(Type cmdletType, MemberInfo memberInfo)
		{
